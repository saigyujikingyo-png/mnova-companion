...
| mnova_job read/cancel | Durable typed records, cancelled-before-start versus cancel-requested, malformed record error with known job ID | Integrated native interruption/cancellation |
